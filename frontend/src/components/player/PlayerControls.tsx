...
import { FullscreenRounded, VolumeDownRounded, VolumeUpRounded, SkipNextRounded } from '@mui/icons-material';
...
const PlayerControls: React.FC<ReactPlayerProps> = (props) => {
  const { state, dispatch, wrapperRef, playerRef, isAdmin } = props;
